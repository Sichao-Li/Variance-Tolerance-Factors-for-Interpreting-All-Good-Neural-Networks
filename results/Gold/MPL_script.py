...
base_model = tf.keras.models.load_model('./base_model_{}_no_scaling.h5'.format(name_prefix))

base_model.trainable = False

stop_call_back = EarlyStoppingByLossVal(monitor='loss', value=0.0025, verbose=0)
